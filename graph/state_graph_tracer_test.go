...
func TestStateGraph_WithTracer(t *testing.T) {
	...
	// Add nodes
	g.AddNode("node1", "First node", func(ctx context.Context, state interface{}) (interface{}, error) {
		return "result1", nil
	})
	
	g.AddNode("node2", "Second node", func(ctx context.Context, state interface{}) (interface{}, error) {
		return "result2", nil
	})
